...
<div class="container content-center">
    <div class="p-10">
        <h1 class="text-3xl font-medium text-center">TERMINATED ACCOUNTS</h1>
    </div>
    <div class="pb-10">
        <form class="max-w-sm mx-auto" method="GET" action="{{ route('searchTerminated') }}"> 
            @csrf  
...
{{-- <script>
    $(document).ready(function(){
        ...
        function fetch_data(query) {
            ...
            $.ajax({
                url:"{{ route('ajaxSearchTerminated') }}",
                method:'GET',
                data:{query:query},
                dataType:'json',
