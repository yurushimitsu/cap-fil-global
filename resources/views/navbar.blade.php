<nav class="" style="background-color: #B1D4E0">
  <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
    ...
    <button data-collapse-toggle="navbar-dropdown" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-1 focus:ring-gray-600" aria-controls="navbar-dropdown" aria-expanded="false">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-dropdown">
      <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-700 rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0">
        ...
        <li>
          <button id="dropdownNavbarLink2" data-dropdown-toggle="dropdownNavbar2" data-dropdown-trigger="hover" class="flex items-center text-sm font-medium w-full py-2 px-3 text-gray-900 rounded-md {{ (Route::is('adminCreateView') || Route::is('adminTableView') || Route::is('adminAnnouncementView')) ? 'bg-gray-700 text-white' : '' }} hover:bg-gray-700 hover:text-white">
            Admin 
            <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
              <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 4 4 4-4"/>
            </svg>
