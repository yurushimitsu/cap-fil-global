...
<div class="pb-25 px-5 md:px-20 bg-[#B1D4E0]">
    <div class="flex justify-center w-full">
        <div class="md:w-230 text-xl md:text-3xl text-center font-bold pt-4 pb-15">
            SUPREME COURT UPHOLDS CAPPI REVISED REHABILITATION
            PLAN AND REFERS CASE TO THE REHABILITATION <br>
            (RTC MAKATI BRANCH 148)
        </div>
    </div>
    <div class="text-lg font-medium">
        <div class="text-center text-justify mb-15">
