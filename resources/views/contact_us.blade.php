...
@section('body')
    <div class="" >
        <div class="m-10 lg:mx-55 md:my-10 rounded-3xl text-center py-10" style="background-color: #B1D4E0">
            ...
            <br>
            <div class="text-2xl md:text-3xl font-bold underline pb-10">CAP OFFICES</div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                Telephone No.: (074) 3045859 <br>
                CAP Building, Burgos Street, DAGUPAN CITY, PANGASINAN <br>
                CAP Building, MacArthur Highway, Brgy. Nancayasan, URDANETA CITY, PANGASINAN <br>
                CAP Building, corner F.R. Castro Avenue & Balintawak Streets, LAOG CITY <br>
            </div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                Telephone No.: (043) 7066928 <br>
                CAP Building, Brgy. Caloocan, Balayan, Batangas <br>
                CAP Building, Granja corner Profugo Streets, LUCENA CITY <br>
                Telephone No.: +63927 1968015 <br>
                CAP Building, P. Guevarra Street, Sta. Cruz, Laguna <br>
                CAP Building, Brgy. San Miguel, PUERTO PRINCESA CITY, Palawan <br>
                Telephone No.: (048) 4332616 <br>
            </div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                Telephone No.: +63981 1094533 <br>
                CAP Building, Fuentes Drive corner Plaridel, ROXAS CITY <br>
                Telephone No.: (036) 5223893 <br>
                CAP Building, Dr. Delfin Encarnacion Avenue, San Jose Antique <br>
                CAP Building, Archbishop Gabriel M. Reyes corner Goding Ramos Streets, Kalibo Aklan <br>
                CAP Building, Guanzon Street National Highway,KABANKALAN CITY, NEGROS OCCIDENTAL <br>
            </div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                Telephone No.: (038) 4226993 <br>
                CAP Building, Carlos P. Garcia Avenue corner J. Borja Street, TAGBILARAN CITY <br>
            </div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                CAP Building, Hagkol National Highway, Valencia, Bukidnon <br>
            </div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                CAP Building, National Highway, Digos Davao del Sur <br>
            </div>
            <br>
            ...
            <div class="text-sm md:text-lg px-1 pb-3">
                ...
                CAP Building, Quezon Blvd. corner Matalam Street, KIDAPAWAN CITY <br>
            </div>
            <br>
